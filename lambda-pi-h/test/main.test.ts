...
const mainProofExp3: TermCheckable = [
  "Inf",
  makeApplyExpr(
    eqIndRAnn,
    ["Inf", ["Nat"]],
...
const mainProofExp4: TermCheckable = [
  "Inf",
  makeApplyExpr(
    eqIndRAnn,
    ["Inf", ["Nat"]],
...
const mainProofExp5: TermCheckable = [
  "Inf",
  makeApplyExpr(
    eqIndRAnn,
    ["Inf", ["Nat"]],
...
const mainProofExp6: TermCheckable = [
  "Inf",
  makeApplyExpr(
    eqIndRAnn,
    ["Inf", ["Nat"]],
...
const mainProofExp7: TermCheckable = [
  "Inf",
  makeApplyExpr(
    eqIndRAnn,
    ["Inf", ["Nat"]],
